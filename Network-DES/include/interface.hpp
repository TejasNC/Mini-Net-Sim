...
class Interface : public std::enable_shared_from_this<Interface> {
    public:
        ...
        void sendPacket(std::shared_ptr<Packet> packet); // Method to send a packet through this interface
        void sendPacketWithContext(std::shared_ptr<Packet> packet, SimulatorContext* ctx); // Send with delay handling
        void receivePacket(std::shared_ptr<Packet> packet); // Method to receive a packet from this interface
